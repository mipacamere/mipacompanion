...
/**
 * MiPA Guest Data Sender — Netlify Function
 * -----------------------------------------
  ...
  try {
    resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: SENDER_EMAIL,
        to: [RECIPIENT_EMAIL],
        subject: 'MiPA — Nuova pratica alloggiati (' + exportData.guests.length + ' ospiti)',
        text: 'In allegato i dati ospiti raccolti dall\'app MiPA.\n\nOspiti: ' + guestNames
